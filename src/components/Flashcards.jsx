    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-4">
      ...
      >
        <div className={`relative w-full h-full duration-500 preserve-3d transition-all ${isFlipped ? 'rotate-y-180' : ''}`}>
          ...
          {/* Back */}
          <div className="absolute w-full h-full backface-hidden bg-blue-50 rounded-2xl shadow-lg border border-blue-100 rotate-y-180 flex flex-col items-center justify-center p-8">
             <span className="text-3xl font-bold text-blue-600 mb-2">{currentWord.pinyin}</span>
      ...
      <div className="flex items-center gap-6 mt-8">
       ...
       <button 
          ...
          className="mt-6 flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 transition-colors"
        >
